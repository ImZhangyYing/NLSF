...
class SegNet(nn.Module):
    def __init__(self):
        ...
        self.outc = OutConv(33, 4)
        self.inc1 = InConv(128, 64)
        self.inc2 = InConv(64, 32)
    ...
    #     x = self.outc(x)
    #     return x
    def forward(self, x1l,x2l,x3l,x4l,f):
        x = torch.cat((x1l,x2l,x3l,x4l),dim=1)
        x1 = self.inc1(x)
        x2 = self.inc2(x1)
        xf = torch.cat((x2,f),dim=1)
        x3 = self.outc(xf)
        return x3
